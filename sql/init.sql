...
INSERT INTO `menu`(`id`, `name`, `key`, `pid`, `order`, `created_at`, `update_at`, `note`) VALUES (2, 'user', 'user', 1, 4, '2022-07-05 21:45:28.000', NULL, NULL);
INSERT INTO `menu`(`id`, `name`, `key`, `pid`, `order`, `created_at`, `update_at`, `note`) VALUES (3, 'menu', 'menu', 1, 5, '2022-07-05 21:45:28.000', NULL, NULL);
